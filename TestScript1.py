#Author-Carl Raymond
#Description-Sampe script to do some learnin'.
...
def run(context):
    ...
    try:
        ...
        innerCircle = sketchCircles.addByCenterRadius(centerPoint, 10)
        outerCircle = sketchCircles.addByCenterRadius(centerPoint, 20)

        # Create a collection of entities for extrude
        entities0 = adsk.core.ObjectCollection.create()

        # Find the profile between the circles. It's the profile with 2 profile loops.
